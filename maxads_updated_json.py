...
selected_ad_ids = selected_ads[len(ads)][best_space]
selected_ad_details = ads_df[ads_df['ad_id'].isin(selected_ad_ids)].to_dict(orient='records')

# output in JSON format
output = {
    "Maximum Profit": max_profit,
    "Selected Ads": selected_ad_details
}
